...
void solve(ll n, vvll& q)
{   
    map<ll, vector<pair<ll, bitset<MAX_BITS>>>> g;
    for (auto& qi : q) {
        ll i = qi[0];
        ll j = qi[1];
        ll x = qi[2];
